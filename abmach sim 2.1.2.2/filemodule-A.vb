Namespace abmach
    Module filemodule
        ...
        Public Function getshortfilename(ByVal filename As String) As String
            ...
            End If
        End Function
        Public Sub read_nc(ByRef nclines() As String, ByVal istartrow As Integer, ByVal ifirstrow As Integer,
                        ByVal ilastrow As Integer)        'read in nc file from textbox
            ...
            Try
                ...
                parsenc(istartrow, nclines(istartrow), 0, comm)
                b = 1
                ' Else
                '  b = 0
                '  End If
        ...
        Public Sub parsenc(ByVal linenumber As Integer, ByRef ncline As String, ByVal line As Integer, ByRef comment As Boolean)

            Dim splitncline(20), word As String
            Dim i As Integer
            word = ""
            Dim fStartIndex, fEndIndex, fLen As Integer
                    ...
                    Else
                        ...
                        For i = splitncline.GetLowerBound(0) To splitncline.GetUpperBound(0)
                            ...
                            If word <> "" Then
                                ...
                                ElseIf word.StartsWith("F") Then
                                    If word.Contains("[") Then
                                        fStartIndex = word.IndexOf("[") + 1
                                        fEndIndex = word.IndexOf("*")
                                        fLen = fEndIndex - fStartIndex
            ...
            Catch ex As Exception
                Debug.WriteLine(ex.Message.ToString() & "stack " & ex.StackTrace.ToString() & " ncline: " & line & " " & word & " sub:parsenc")
            End Try
