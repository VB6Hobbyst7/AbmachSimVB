...
Namespace abmach
    ...
    Public Class Form1
        ...
        Dim tmifilename As String
        Dim miCsvFilename As String
        ...
        Dim modelInputParms As modelParms
        ...
        Friend WithEvents ButtonStopBackground As System.Windows.Forms.Button
        Friend WithEvents ButtonRunBackground As System.Windows.Forms.Button
...
#Region " Windows Form Designer generated code "
        ...
        Private Sub InitializeComponent()
            ...
            Me.mnuEquationTargetDepth = New System.Windows.Forms.MenuItem()
            ...
            Me.mnuEquationMask = New System.Windows.Forms.MenuItem()
            ...
            CType(Me.pct_tooshallow, System.ComponentModel.ISupportInitialize).BeginInit()
            CType(Me.Intolerance, System.ComponentModel.ISupportInitialize).BeginInit()
            CType(Me.pcttoodeep, System.ComponentModel.ISupportInitialize).BeginInit()
            CType(Me.pctthrupart, System.ComponentModel.ISupportInitialize).BeginInit()
            ...
            Me.menuItem6.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnurescalefeedrates, Me.mnureplacefeedrates, Me.MenuItem11, Me.mnuncdxf, Me.mnudynjetonoff, Me.mnuscanfile, Me.mnuRenumberFile, Me.mnuoptions})
            ...
            Me.MenuItem11.Text = "Shift Program"
            '
            'mnuncdxf
            '
            Me.mnuncdxf.Index = 3
            ...
            Me.MenuItem8.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuconstd, Me.mnudxfin, Me.mnu2dpts, Me.mnudxfpoints, Me.mnuEquationTargetDepth})
            ...
            '
            'mnuEquationTargetDepth
            '
            Me.mnuEquationTargetDepth.Index = 4
            Me.mnuEquationTargetDepth.Text = "Equation"
            '
            'MenuItem3
            '
            ...
            '
            Me.mnudxfregionstartdepth.Enabled = False
            ...
            Me.MenuItem4.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuNoMask, Me.mnuDxfMaskPontFile, Me.mnuEquationMask})
            ...
            'mnuEquationMask
            '
            Me.mnuEquationMask.Index = 2
            Me.mnuEquationMask.Text = "Equation"
            '
            'openFileDialog
            '
            ...
            Me.runinfo.Location = New System.Drawing.Point(12, 299)
            ...
            Me.labeliteration.Size = New System.Drawing.Size(45, 13)
            ...
            Me.labelrun.Size = New System.Drawing.Size(27, 13)
            ...
            Me.labeldepth.Size = New System.Drawing.Size(73, 13)
            ...
            Me.outputoptions.Location = New System.Drawing.Point(227, 444)
            ...
            Me.runAsIs.Size = New System.Drawing.Size(104, 24)
            ...
            Me.newfeedoption.Size = New System.Drawing.Size(104, 24)
            ...
            Me.newMiOption.Size = New System.Drawing.Size(104, 24)
            ...
            Me.Richtextbox1.Size = New System.Drawing.Size(479, 293)
            ...
            Me.PictureBox1.Size = New System.Drawing.Size(787, 293)
            ...
            Me.GroupBox1.Location = New System.Drawing.Point(485, 299)
            ...
            Me.PictureBox2.Size = New System.Drawing.Size(517, 242)
            ...
            Me.Panel3.Location = New System.Drawing.Point(227, 306)
            ...
            'sbfrm1
            '
            Me.sbfrm1.Location = New System.Drawing.Point(0, 603)
            ...
            Me.sbfrm1.Size = New System.Drawing.Size(1284, 20)
            ...
            Me.sbpstarttime.Name = "sbpstarttime"
            ...
            Me.startdepth.Name = "startdepth"
            Me.startdepth.Width = 218
            '
            'targetdepth
            '
            Me.targetdepth.AutoSize = System.Windows.Forms.StatusBarPanelAutoSize.Spring
            Me.targetdepth.Name = "targetdepth"
            Me.targetdepth.Width = 218
            '
            'parmfilename
            '
            Me.parmfilename.AutoSize = System.Windows.Forms.StatusBarPanelAutoSize.Spring
            Me.parmfilename.Name = "parmfilename"
            Me.parmfilename.Width = 218
            '
            'mask
            '
            ...
            Me.ButtonStopBackground.TabStop = False
            Me.ButtonStopBackground.Text = "Stop Back"
            '
            'ButtonRunBackground
            '
            ...
            Me.runinfo.PerformLayout()
            Me.outputoptions.ResumeLayout(False)
            CType(Me.PictureBox1, System.ComponentModel.ISupportInitialize).EndInit()
            Me.GroupBox1.ResumeLayout(False)
            Me.GroupBox1.PerformLayout()
            CType(Me.pct_tooshallow, System.ComponentModel.ISupportInitialize).EndInit()
            CType(Me.Intolerance, System.ComponentModel.ISupportInitialize).EndInit()
            CType(Me.pcttoodeep, System.ComponentModel.ISupportInitialize).EndInit()
            CType(Me.pctthrupart, System.ComponentModel.ISupportInitialize).EndInit()
...
#Region " Main Form Menu code "
        ...
        Protected Sub mnuOpen_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuOpen.Click
            Try
                ...
                Dim a As Integer = 0
                openfiledialog1.Filter = "PIM files(*.pim)|*.pim|NC files(*.nc)|*.nc|All Files(*.*)|*.*"
        ...
        Private Sub MenuItem11_Click(sender As Object, e As EventArgs) Handles MenuItem11.Click
            Dim shftform As New ShiftProgForm
            If (shftform.ShowDialog() = Windows.Forms.DialogResult.OK) Then
        ...
        Private Sub mnurescalefeedrates_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnurescalefeedrates.Click
            ...
            If fileloaded Then
                ...
                Dim lastline As Integer = ilength
                Dim scaleFactor As Double
                Try
                    Dim rescaleFeeds As New rescaleFeedratesForm
                    If (rescaleFeeds.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                        changerange = rescaleFeeds.changeRange
                        scaleFactor = rescaleFeeds.scaleFactor
                        If (changerange) Then
                            firstLine = rescaleFeeds.firstLine
                            lastline = rescaleFeeds.lastLine

                        End If
                    End If
                    nclines = Richtextbox1.Lines
                    read_nc(nclines, istartrow, ifirstrow, ilastrow)
                    rewritetextbox(nclines)
                    'check to see line numbers are within the program.
                    'added change range of line numbers from change whole program 8-7-13
                    If (nc(ilength - 1).n < lastline) Then
                        lastline = nc(ilength - 1).n
                    End If
                    If (nc(0).n > firstLine) Then
                        firstLine = nc(istartrow).n
                    End If
                    If (changerange) Then
                        For i = 0 To ilength
                            If ((nc(i).n >= firstLine) And (nc(i).n <= lastline)) Then
                                newfeed(i) = nc(i).f * scaleFactor
                            Else
                                newfeed(i) = nc(i).f
                            End If
        ...
        Private Sub mnudynjetonoff_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnudynjetonoff.Click
            ...
            Dim ncline, newnclines() As String
            nclines = Richtextbox1.Lines
        ...
        Private Sub mnuEquationTargetDepth_Click(sender As Object, e As EventArgs) Handles mnuEquationTargetDepth.Click
            mnuconstd.Checked = False
            mnu2dpts.Checked = False
            mnudxfin.Checked = False
            mnudxfpoints.Checked = False
            mnuEquationTargetDepth.Checked = True
            targetSurfaceOK = False
            targetsurfacetype = surfacetype.equation
        End Sub
        ...
        Private Sub mnu_save_dxf_surf_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnusavedxfsurf.Click
            If model_run_success Then
                save_dxf_surf_file(dxffilename, surface, target_surface, outputmesh,
        ...
        Private Sub mnu_save_csv_surf_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnusavecsvsurf.Click
            If model_run_success Then
                save_csv_surf_file("X,Y,Z", surfacefilename, surface, outputmesh, mesh_size)
                'added 10-21-2014 
                Dim targetfilePath As String = Path.GetFileNameWithoutExtension(surfacefilename)
                targetfilePath = targetfilePath + "-target.csv"

                save_csv_surf_file("X,Y,Z", targetfilePath, target_surface, outputmesh, mesh_size)
        ...
        Private Sub mnuCsvMi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuCsvMi.Click
            Try
                ...
                If openfiledialog1.ShowDialog() = DialogResult.OK Then
                    miSurfaceOK = False
                    surfInputOK = (surfin.readcsvsurffile(fileType.mi, openfiledialog1.FileName))
        ...
        Private Sub mnuDxfMi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDxfMi.Click
            Try
                ...
                If openfiledialog1.ShowDialog() = DialogResult.OK Then
                    miSurfaceOK = False
                    surfInputOK = (surfin.readDxfSurfFile(fileType.mi, openfiledialog1.FileName))
        ...
        Private Sub mnuNoMask_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuNoMask.Click
            ...
            mnuEquationMask.Checked = False
            mnuDxfMaskPontFile.Checked = False
            ' refreshpanel(5, "None")
        End Sub
        Private Sub mnuEquationMask_Click(sender As Object, e As EventArgs) Handles mnuEquationMask.Click

            mnuEquationMask.Checked = True
            mnuNoMask.Checked = False
            mnuDxfMaskPontFile.Checked = False
            maskSurfaceType = surfacetype.equation
            maskSurfaceOK = False
        End Sub
        Private Sub mnuDxfMaskPontFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDxfMaskPontFile.Click
            ...
            Try
                ...
                If openfiledialog1.ShowDialog() = DialogResult.OK Then
                    ...
                    surfInputOK = surfin.readDxfSurfFile(fileType.mask, openfiledialog1.FileName)
                End If
...
#Region " Picture box code "
        ...
        Private Sub displaypicture(ByRef gd As Graphics, ByVal ft As displaytransform, ByVal bbrsh As Brush, ByVal gbrsh As Brush,
                            ByVal ybrsh As Brush, ByVal rbrsh As Brush, ByVal blkbrsh As Brush)
            Try
                Dim rectsize As Integer
                Dim i, i0, j0, i1, j1, j, x, y, xp, yp, ypp, x3, y3, yppp As Integer
                Dim x1, x2, y2, y1 As Double
                Dim sp As Integer = 10
                Dim lw As Integer = 5
                Dim sx, sy As String
                Dim fr, fr1, fr2, fr3 As Double
                Dim printFont As Font = Me.Richtextbox1.Font
                Dim fontheight As Integer = Me.Richtextbox1.Font.Height
                Dim minDepth, maxDepth, targetDepth As Double
        ...
        Function feedrateatarraypoint(ByVal x As Double, ByVal y As Double) As Double
            Dim i, min_i, toolpathend As Integer
        ...
        Private Sub drawsection(ByVal i0 As Integer, ByVal j0 As Integer, ByVal i1 As Integer, ByVal j1 As Integer)
            ...
            Dim x, y, zmin, zmax, dx, dy, x0, y0, x1, y1, depthrange, sy, sx As Double
            zmin = 9.0E+20
            zmax = 0
...
#End Region
        ...
        Sub scanfile()
            Try
                ...
                Me.ButtonRunBackground.Enabled = True
        ...
        Private Sub scannc(ByVal linetoread As String, ByRef linepos As Integer,
                           ByRef firstrow As Integer, ByRef lastrow As Integer,
                           ByRef startlocation As Integer, ByRef commentcount As Integer,
                            ByRef ccomp As String)


            Static firstrowoffset As Integer
            Dim i As Integer
        ...
        Sub refreshpanel(ByVal panel As Integer, ByVal txt As String)
            ...
            Catch ex As Exception
                MessageBox.Show(ex.Message.ToString() & "sub:refreshpanel")
            End Try
        ...
        Private Sub modelrun()
            ...
            Dim itercount, iterations, i, j, r, runs, maxdfi, maxi, mini As Integer
            ...
            Try
                If Not (ncfilename Is Nothing) Then
                    ...
                    If validdata And fileloaded Then
                        ...
                        ReDim nc(ilength)
                        ' Dim debugDataSize As Integer = jetradius * 2 * r
                        ' ReDim debugData(debugDataSize)
                        nclines = Richtextbox1.Lines
                        read_nc(nclines, istartrow, ifirstrow, ilastrow)
                        Me.rewritetextbox(nclines)
                        ...
                        If Not (targetSurfaceOK) Then
                            ...
                            If targetsurfacetype = surfacetype.csvpoints Or targetsurfacetype = surfacetype.dxfpoints Then
                                ...
                                FillArrayFromXCurve(targetSurfaceOK, targetCurve, target_surface)
                            ...
                            'create surface from equation for spherical mirror 10-1-2013
                            If targetsurfacetype = surfacetype.equation Then
                                createTargetSurfaceFromEq(targetSurfaceOK, surfacetype.equation, targetExtents, target_surface)
                                If targetSurfaceOK Then
                                    refreshpanel(3, shorttargetfilename)
                                    If targpref Then
                                        save_dxf_surf_file(targetfilename, target_surface, target_surface, outputmesh, mesh_size,
                                                           ccomp, pathmin_x, pathmin_y, 9.0E+20, 9.0E+20, material_thickness)
                                    End If
                                End If
                        ...
                        If Not (maskSurfaceOK) Then
                            ...
                            If maskSurfaceType <> surfacetype.constant Then
                                ...
                                If maskSurfaceType <> surfacetype.equation Then
                                    interpolate2dSurface(maskSurfaceOK, maskSurfaceType, maskExtents, maskSurface, tMaskSurface)
                                Else
                                    createMaskSurfaceFromEqu(maskSurfaceOK, maskSurfaceType, maskExtents, maskSurface)
                                End If
                        ...
                        If Me.newfeedoption.Checked Then
                            ...
                            '    Me.Replacefeedrates(nom_feedrate)
                        End If
                        ...
                        Dim maxProgress As Integer = iterations * runs
                        ...
                        For itercount = 1 To iterations
                            ...
                            'Label25.Text = "Jet Diam: " + ccomp.ToString()
                            Do While r <= runs And depthok
                                ...
                                Dim percentComplete As Integer = CSng(totalRuns) / CSng(maxProgress) * 100
                ...
                Else
                    ...
                    refreshpanel(1, "-")
                End If
                ' SaveTextFile("debugData.csv", debugdataList)
        ...
        End Sub
        Public Sub SaveTextFile(filename As String, text As Generic.List(Of String))
            ...
            m_streamWriter.Close()
        End Sub
        'Private Function modelSetupBackground() As modelParms
        '    Dim infofileout As New infofile
        '    Dim surfacefile As New surfacefile
        '    Dim dxfoutput As New DXFfile
        '    Dim iterations, runs As Integer
        '    Dim validdata As Boolean 'startSurfaceOK, targetSurfaceOK, miSurfaceOK
        '    Dim tot_path_l As Double
        '    Dim modelInputParms As New modelParms
        '    Static runversion As Integer
        '    Try
        ...
        '                starttargetfilename = filename & ".startsurf.v" & runversion & ".dxf"
        '                miFileName = filename & ".mi.v" & runversion & ".dxf"
        '                tmifilename = filename & ".tmi.v" & runversion & ".dxf"
        '                miCsvFilename = filename & ".mi.v" & runversion & ".csv"
        '                ReDim nc(ilength)
        ...
        '                            refreshpanel(3, shorttargetfilename)
        '                            If targpref Then
        '                                save_dxf_surf_file(targetfilename, target_surface, target_surface, outputmesh, mesh_size, _
        '                                                   ccomp, pathmin_x, pathmin_y, 9.0E+20, 9.0E+20, material_thickness)
        '                            End If
        '                        End If
        ...
        '                End If
        '                Me.iterationnumber.Text = iterations
        '                modelInputParms.iterations = iterations
        '                modelInputParms.runs = runs
        '                If runAsIs.Checked Then
        '                    modelInputParms.opt = modelOutputOptions.runAsIs
        '                End If
        '                If newfeedoption.Checked Then
        '                    modelInputParms.opt = modelOutputOptions.newFeedrates
        '                End If
        '                If newMiOption.Checked Then
        '                    modelInputParms.opt = modelOutputOptions.newMISurface
        '                End If
        '                If mrradjust.Checked Then
        '                    modelInputParms.opt = modelOutputOptions.newMISurface
        '                End If
        ...
        '                    modelInputParms.opt = modelOutputOptions.newMISurface
        '                End If
        '                modelInputParms.depthX = CDbl(Me.depthx.Text)
        '                modelInputParms.depthY = CDbl(Me.depthy.Text)



        '            End If
        '        End If
        '        Return modelInputParms
        ...
        '    End Try
        'End Function
        Private Sub modelPostRunProcess()
            Dim infofileout As New infofile
            Dim surfacefile As New surfacefile
            Dim dxfoutput As New DXFfile

            If newMiOption.Checked Then
                surfacefile.filesave("X,Y,MI", miCsvFilename, mi_surface, outputmesh, mesh_size)
            End If

            If mipref Then
                dxfoutput.dxfsave(miFileName, mi_surface, outputmesh, mesh_size, ccomp, pathmin_x, pathmin_y)
            End If
            'run one more time with new feedrates 
            Me.PictureBox1.Cursor = System.Windows.Forms.Cursors.Cross
        ...
        End Sub
        'Private Function modelRunBackground(parms As modelParms, worker As BackgroundWorker, ByVal e As DoWorkEventArgs) As Boolean

        '    Dim itercount, i, j, r, maxdfi, maxi, mini As Integer
        '    Dim maxProgress As Integer = parms.iterations * parms.runs
        '    Dim totalRuns As Integer = 0
        '    Dim newmrr As Decimal
        ...
        '        e.Cancel = True
        '    Else
        '        For itercount = 1 To parms.iterations
        ...
        '                fillarrays(ilength)
        '            End If
        '            Dim time As Double = parms.runs * timetomachine()
        '            'If time >= 60 Then
        ...
        '            Do While r <= parms.runs And depthok
        '                totalRuns += 1
        '                'currun.Text = CStr(r)
        '                'curiter.Text = CStr(itercount)
        '                'curmrr.Text = CStr(depth_per_run)
        '                'run model
        '                success = subtract_surface(r)
        '                If Not success Then Throw New Exception("Error during surface subtraction")

        '                Dim percentComplete As Integer = CSng(totalRuns) / CSng(maxProgress) * 100
        '                worker.ReportProgress(percentComplete)

        '                'curdepth.Text = CStr(avedepth(CDbl(depthx.Text), CDbl(depthy.Text), 2))
        '                depth_display(r) = avedepth(modelInputParms.depthX, modelInputParms.depthY, 2)
        ...
        '                    Throw New Exception("Error during new feedrate calc.")
        '                End If
        '                If ((modelInputParms.opt = modelOutputOptions.newFeedrates) And (itercount < parms.iterations)) Then
        '                    Dim newf(ilength) As Double
        '                    For i = 0 To ilength
        '                        newf(i) = Math.Round(nc(i).newf, 2)
        '                    Next
        ...
        '                End If
        '                If newMiOption.Checked And itercount < parms.iterations Then
        '                    adjustMiArray()
        '                End If
        '            Else
        '                Throw New Exception("Unknown Error")
        ...
        Private Sub dxf_to_target_surface(ByRef targetSurfaceOK As Boolean, ByVal regionpoint() As mdmodel.ddepthpoint,
        ...
        End Sub 'dxf_to_target_surface
        Private Sub interpolate2dSurface(ByRef localTargetSurfaceOK As Boolean, ByVal input As surfacetype,
                    ...
                    For j = 0 To outputSurface.GetUpperBound(1)
                        For i = 0 To outputSurface.GetUpperBound(0)
                            ...
                            Else
                                xm = xm - (localArrayExtents.min_x + (sc * localArrayExtents.xmeshsize))
                                ym = ym - (localArrayExtents.min_y + (sr * localArrayExtents.ymeshsize))
                                outputSurface(i, j) = Math.Round(txy(sr, sc, inputSurface(sc, sr), inputSurface(sc, sr + 1),
                                                                 inputSurface(sc + 1, sr + 1), inputSurface(sc + 1, sr),
        ...
        Private Sub createTargetSurfaceFromEq(ByRef localtargetSurfaceOK As Boolean, ByVal input As surfacetype,
                                         ByVal localArrayExtents As mdmodel.dArrayExtents, ByRef outputsurface(,) As Double)
            Dim i, j As Integer
            Dim xm, ym As Double
            Dim r As Double
            Dim rSphere As Double
            Dim rAperture As Double
            Dim depthAtCenter As Double
            ...
            For j = 0 To outputsurface.GetUpperBound(1)
                For i = 0 To outputsurface.GetUpperBound(0)
                    xm = getxlocation(i, mesh_size, ccomp, pathmin_x)
                    ym = getylocation(j, mesh_size, ccomp, pathmin_y)
                    r = Math.Sqrt(Math.Pow(xm, 2) + Math.Pow(ym, 2))
                    If (r > rAperture) Then
                        r = rAperture
                    End If
                    height = depthAtCenter + (rSphere - Math.Sqrt(Math.Pow(rSphere, 2) - Math.Pow(r, 2)))
                    outputsurface(i, j) = height
                Next
            Next
            localtargetSurfaceOK = True
        End Sub
        Private Sub createMaskSurfaceFromEqu(ByRef localtargetSurfaceOK As Boolean, ByVal input As surfacetype,
                                         ByVal localArrayExtents As mdmodel.dArrayExtents, ByRef outputsurface(,) As Integer)
            Dim i, j As Integer
            Dim xm, ym As Double
            Dim r As Double
            Dim rAperture As Double
        ...
        Private Function interpolateCurve(inputX As Double, inputCurve() As Curve) As Double


            Dim lesserNeighbor As Curve
            Dim greaterNeighbor As Curve
            Dim neighborFound As Boolean


            If inputX <= inputCurve(0).X Then
                lesserNeighbor = inputCurve(0)
                greaterNeighbor = inputCurve(0)
            ElseIf inputX > inputCurve(inputCurve.Length - 1).X Then
                lesserNeighbor = inputCurve(inputCurve.Length - 1)
                greaterNeighbor = inputCurve(inputCurve.Length - 1)
            Else
                For i As Integer = 0 To inputCurve.Length - 2
                    If Not (neighborFound) And inputX >= inputCurve(i).X And inputX < inputCurve(i + 1).X Then
                        lesserNeighbor = inputCurve(i)
                        greaterNeighbor = inputCurve(i + 1)
                        neighborFound = True
                    End If
                Next
            End If
            ...
            numerator = (greaterNeighbor.Fx - lesserNeighbor.Fx)
            Dim denominator As Double
            denominator = (greaterNeighbor.X - lesserNeighbor.X)
            Dim slope As Double
            If numerator = 0 Then
                fx = lesserNeighbor.Fx
            ElseIf denominator = 0 Then
                fx = (lesserNeighbor.Fx + greaterNeighbor.Fx) / 2
            Else
                slope = numerator / denominator
                fx = (inputX - lesserNeighbor.X) * slope + lesserNeighbor.Fx
            End If

            Return fx

        End Function
        Private Sub FillArrayFromXCurve(ByRef localtargetSurfaceOK As Boolean, ByVal inputCurve() As Curve, ByRef outputSurface(,) As Double)
            Dim i, j As Integer
            Dim xm, tempz As Double


            For i = 0 To outputSurface.GetUpperBound(0)
                xm = getxlocation(i, mesh_size, ccomp, pathmin_x)
                tempz = interpolateCurve(xm, inputCurve)
                For j = 0 To outputSurface.GetUpperBound(1)
                    ...
                    For j = 0 To outputsurface.GetUpperBound(1)
                        For i = 0 To outputsurface.GetUpperBound(0)
                            ...
                            Else
                                ...
                                outputsurface(i, j) = txy(sr, sc, inputsurface(sc, sr), inputsurface(sc, sr + 1),
                                              inputsurface(sc + 1, sr + 1), inputsurface(sc + 1, sr),
        ...
        Private Sub findsubblock(ByVal x As Double, ByVal y As Double, ByVal dtarget As mdmodel.dArrayExtents,
        ...
        Private Function txy(ByVal row As Integer, ByVal column As Integer, ByVal trc As Double, ByVal trpc As Double, ByVal trpcp As Double,
                             ByVal trcp As Double, ByVal x As Double,
        ...
        Function isnumber(ByVal testString As String) As Boolean
            ...
            Do While i <= 9
                testnumber = CStr(i)
                test = String.Equals(testString, testnumber)
                If test Then
                    Return test
                    Exit Do
                End If
        ...
        Sub Replacefeedrates(ByVal replacef As Double)
            ...
            Try
                Dim len As Integer = nclines.GetUpperBound(0)
                Dim newFeeds(len) As Double
                For i As Integer = 0 To len
                    newFeeds(i) = replacef
                Next
                Replacefeedrates(newFeeds)
            Catch ex As Exception
                Throw
            End Try
        ...
        Sub Replacefeedrates(ByVal replacef() As Double)
            ...
            Try
                ...
                For i = nclines.GetLowerBound(0) To nclines.GetUpperBound(0) - 1
                    If Not (nc(j).isComment) Then
                ...
                rewritetextbox(newnclines)
            Catch ex As Exception
                Throw New Exception(ex.Message + " at line " + nc(j).line)
                'MessageBox.Show(ex.Message.ToString() & " lineLen:" & nc(j).line.Length & " fpos:" & nc(j).fpos & " flen:" & nc(j).flen & " sub:replacefeedrates")
            End Try
        ...
        Public Sub renumberFile(ByVal startValue As Integer, ByVal increment As Integer)
            Dim i, jmax, imax, nIndexStart, nIndexEnd, newN, lineLength As Integer
        ...
        Private Sub BackgroundWorker1_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundWorker1.DoWork
            ...
            'e.Result = modelRunBackground(e.Argument, worker, e)
        End Sub
        ...
        Private Sub ButtonRunBackground_Click(sender As Object, e As EventArgs) Handles ButtonRunBackground.Click
            Me.ButtonRunBackground.Enabled = False
            Me.ButtonStopBackground.Enabled = True
            ' modelInputParms = Me.modelSetupBackground()
            BackgroundWorker1.RunWorkerAsync(modelInputParms)
        End Sub

        Private Sub ButtonStopBackground_Click(sender As Object, e As EventArgs) Handles ButtonStopBackground.Click
            Me.ButtonRunBackground.Enabled = True
            Me.ButtonStopBackground.Enabled = False
