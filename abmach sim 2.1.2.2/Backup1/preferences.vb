...
Namespace abmach
    Public Class preferences
        ...
        Dim sprefmxmlfilepath As String = sdir & System.IO.Path.DirectorySeparatorChar & prefxmlfile
...
#End Region
        ...
        Public Sub loadpreferences()
            Try
                If File.Exists(sprefmxmlfilepath) Then
                    Dim xmlDoc As XmlDocument = New XmlDocument
                    xmlDoc.Load(sprefmxmlfilepath)
        ...
        Private Sub btn_OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_OK.Click
            Try
                ...
                targetSurfaceOK = False
                surfaceOK = False
                Dim xmlwriter As New XmlTextWriter(sprefmxmlfilepath, Nothing)
