Namespace abmach
    Module filemodule
        ...
        Public Sub parsenc(ByVal linenumber As Integer, ByRef ncline As String, ByVal line As Integer, ByRef comment As Boolean, ByRef vscaling As Boolean)
            ...
            Dim splitncline(20), word, trword As String
            Dim u, l, i As Integer
            Dim nindex, gindex, xindex, yindex, zindex, iindex, jindex, bindex, cindex, findex, excindex As Integer
            ...
            Try
                If Not (ncline Is Nothing) Then
                    ...
                    If ncline.StartsWith(machine.machinecomment) Then
                        comment = True
                    Else
